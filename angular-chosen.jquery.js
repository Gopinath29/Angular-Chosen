...
function () {
    ...
    a = this, AbstractChosen = function () {
        ...
        return AbstractChosen.prototype.set_default_values = function () {
            ...
            return null != this.options.width ? this.options.width : ""+80+"%";
...
function () {
    ...
    b = this, a = jQuery, a.fn.extend({
        ...
        return e(Chosen, d), Chosen.prototype.setup = function () {
            ...
            var c;
            c = a(b.target).hasClass("active-result") ? a(b.target) : a(b.target).parents(".active-result").first(), c.length ? (this.result_highlight = c, this.result_select(b), this.search_field.focus()) : void 0
        	setScopeValue(this);
        	return c;
            ...
            var c, d;
            return d = this.results_data[b], this.form_field.options[d.options_index].disabled ? !1 : (d.selected = !1, this.form_field.options[d.options_index].selected = !1, this.selected_option_count = null, c = a("#" + this.container_id + "_o_" + b), c.removeClass("result-selected").addClass("active-result").show(), this.result_clear_highlight(), this.winnow_results(), this.form_field_jq.trigger("change", {
...
function setScopeValue(refer) {
	var scope = angular.element(document.getElementById(refer.form_field.id)).scope();
	var ngmodel = $("#" + refer.form_field.id).attr("ng-model");
	ngmodel = ngmodel.split('.');
	var object = ngmodel[0];
	var model = ngmodel[1];
	scope[object][model] = refer.form_field.options[refer.current_selectedIndex].text;
	scope.$apply();
}
